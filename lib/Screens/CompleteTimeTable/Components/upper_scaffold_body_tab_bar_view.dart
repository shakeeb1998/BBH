import 'package:test1/Screens/AlternateSlots/alternate_slot_screen.dart';
import 'package:test1/Screens/TimeTable/Components/class_card.dart';
import 'package:test1/Screens/TimeTable/Components/custom_tab_indicator.dart';
    ...
    return ListView.builder(itemCount: widget.slotsClasses.length,itemBuilder: (context,index){
      return Padding(
        ...
        child: Padding(
          ...
          child: InkWell(
            onTap: (){
              Navigator.push(context, new MaterialPageRoute(builder: (context)=>AlternateSlotScreen()));
            },
            child: ClassCard(
